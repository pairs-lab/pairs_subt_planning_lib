...
#include "pairs_subt_planning_lib/pcl_map.h"

namespace pairs_subt_planning
{
  ...
  public:
    ...
    void initialize(octomap::point3d start_point, octomap::point3d goal_point, std::shared_ptr<octomap::OcTree> planning_octree,
                    ...
                    double max_altitude, bool debug, std::shared_ptr<pairs_lib::BatchVisualizer> batch_visualizer,
    ...
    void initialize(bool enable_planning_to_unreachable_goal, double planning_timeout_, double postprocessing_timeout_, double safe_dist, double clearing_dist,
                    double min_altitude, double max_altitude, bool debug, std::shared_ptr<pairs_lib::BatchVisualizer> batch_visualizer,
  ...
  protected:
    ...
    std::shared_ptr<pairs_lib::BatchVisualizer> batch_visualizer_;
