...
# dependency .debs from /prebuilt, then builds pairs_subt_planning_lib and copies the .deb to /output.
...
LOCAL_RULES="/src/pairs_subt_planning_lib/packaging/rosdep/pairs.yaml"
...
build_one /src/pairs_subt_planning_lib
